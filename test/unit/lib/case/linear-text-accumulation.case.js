...
const heedFile = await readAsset(import.meta.url, './linear-text-accumulation.heed');

const tokenized = [
  { line: 1, depth: 1, type: 'blockStart', blockType: 'text', attrText: '' },
  { line: 2, depth: 1, type: 'macroAttr', key: 'accumulate.content', value: 'arbitrary-name' },
  ...
  { line: 7, depth: 1, type: 'macroAttr', key: 'accumulate.content', value: 'arbitrary-name' },
  ...
  { line: 12, depth: 1, type: 'macroAttr', key: 'accumulate.content', value: 'arbitrary-name' },
  { line: 13, depth: 1, type: 'content', value: 'and they call absolutely none of them'},
  { line: 14, depth: 1, type: 'blockEnd', data: '--' },

  { line: 16, depth: 1, type: 'blockStart', blockType: 'text', attrText: '' },
  { line: 17, depth: 1, type: 'macroAttr', key: 'accumulate.content', value: 'arbitrary-name' },
