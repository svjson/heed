...
const heedFile = await readAsset(
  import.meta.url,
  'slide-with-notes-aside-block.heed',
);
...
const tokenized = [
  { line: 5, depth: 1, type: 'blockStart', blockType: 'text', attrText: '' },
  {
    ...
    depth: 1,
    type: 'content',
    value: 'Every slice of toast is now immutably recorded on the blockchain.',
  },
  ...
  { line: 10, depth: 1, type: 'content', value: 'Points to drive home:' },
  {
    ...
    depth: 1,
    type: 'content',
    value: '- Regular crypto scams are becoming less and less lucrative.',
  },
  {
    line: 12,
    depth: 1,
  ...
  { line: 13, depth: 1, type: 'content', value: '- Everybody likes toast' },
  {
    ...
    depth: 1,
    type: 'content',
    value: '- Toast is the new crypto scam.',
  },
  ...
  contents: [
    {
      ...
      children: [],
      content:
        'Every slice of toast is now immutably recorded on the blockchain.',
    },
  ],
  notes: [
    {
