...
const description = 'several html-blocks, revealed step-by-step through %reveal-macro';

const heedFile = await readAsset(import.meta.url, './reveal-frontmatter-macro.heed');

const tokenized = [
  { line: 6, depth: 1, type: 'blockStart', blockType: 'html', attrText: '{ id=bull1 }' },
  { line: 7, depth: 1, type: 'content', value: '<b>1.</b> Install Emacs' },
  { line: 8, depth: 1, type: 'blockEnd', data: '--' },

  { line: 10, depth: 1, type: 'blockStart', blockType: 'html', attrText: '{ id=bull2 }' },
  { line: 11, depth: 1, type: 'content', value: '<b>2.</b> Discover that tinkering with your configuration...' },
  { line: 12, depth: 1, type: 'blockEnd', data: '--' },

  { line: 14, depth: 1, type: 'blockStart', blockType: 'html', attrText: '{ id=bull2a }' },
  ...
  { line: 19, depth: 1, type: 'blockStart', blockType: 'html', attrText: '{ id=bull2b }' },
  { line: 20, depth: 1, type: 'attr', key: 'style', value: 'font-size: 15px;' },
  { line: 21, depth: 1, type: 'content', value: '<b>b)</b> Never ever (ever) ends...' },
  { line: 22, depth: 1, type: 'blockEnd', data: '--' },

  { line: 24, depth: 1, type: 'blockStart', blockType: 'html', attrText: '{ id=bull3 }' },
  { line: 25, depth: 1, type: 'content', value: '<b>3.</b> Everlasting joy has been achieved!' },
