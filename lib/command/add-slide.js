...
export const addSlide = async (presentationRoot, presentationFile, slideId, contextPath, opts) => {
  ...
  const fileName = resolveFileName(index, contextPath, prevSlide, slideId, presentation);
 ...
 */
const resolveFileName = (index, contextPath, prevSlide, slideId, presentation) => {
