...
import {
  expandBlockMacros,
  expandFrontmatterMacros,
  expandMacroAttributes,
} from './macro/index.js';
 ...
 * 5. Expand block-macros
 * 6. Parse and evaluate aside blocks
 * 7. Expand frontmatter and attributes macros.
 *
 ...
 */
export const parseHeedFile = (text, presentation) => {
  ...
  const meta = parseAsideBlocks(asideBlocks, slideIr, presentation?.plugins);

  return expandFrontmatterMacros(expandMacroAttributes(slideIr, meta));
};
